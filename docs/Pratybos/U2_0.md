...
👉 Žr. **[Užduočių Gidas](UzduotiuGidas_1_1.md)**

---

## 🎯 Užduoties tikslas

Išmokti kurti C++ klases, suprasti **enkapsuliacijos** principą, dirbti su **konstruktoriais** ir **destruktoriais**. Praktikuoti **statinius narius** ir masyvų evoliuciją objektų kontekste.
...
**Daugiau klausimų?** → Žr. [Užduočių Gidas - DUK](UzduotiuGidas_1_1.md#duk)
